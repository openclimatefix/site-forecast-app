...
- `LOAD_SITES_FROM_DATA_PLATFORM`: Whether to load the sites to forecast from the Data Platform instead of the database. Defaults to `false`.
...
## Running the app locally via a notebook
The example notebook is [here](run_app_locally.ipynb), follow the instructions inside.
