...
def limit_adjuster(delta_fraction: float,
                   value_fraction: float,
                   capacity_mw: float,
                   adjuster_limit_fraction: float = adjuster_limit_fraction_default,
                   adjuster_limit_mw: float = adjuster_limit_mw_default) -> float:
