...
async def test_fetch_generation_from_dp_success():
    ...
    # Ensure it behaves like protobuf Timestamp or standard datetime
    mock_obs_val1.timestamp_utc = datetime(2024, 6, 1, 10, 0, tzinfo=UTC)
    ...
    mock_loc_resp.effective_capacity_watts = 2000  # 2 kW
    mock_client.get_location.return_value = mock_loc_resp
