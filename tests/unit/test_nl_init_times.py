...
def test_calculate_model_delays():
    ...
    model_init_times = {
        ...
        "model_B": pd.Timestamp("2024-01-01 11:45", tz="UTC"), # Will be floored to 11:30
    ...
    assert delays["model_B"] == pd.Timedelta("30min") # Floored 11:45 -> 11:30 => 30min delay
...
def test_shift_mae_curves():
    ...
    horizons = [pd.Timedelta("30min"), pd.Timedelta("60min"), pd.Timedelta("90min"), pd.Timedelta("120min")]
